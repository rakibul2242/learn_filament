<main>
    <div class="container mx-auto p-6">
        <h1 class="text-3xl font-extrabold mb-8 text-center text-gray-800">Available Courses</h1>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            @foreach ($courses as $course)
                <div
                    class="bg-white rounded-xl shadow-lg overflow-hidden transform transition hover:scale-105 hover:shadow-2xl">
