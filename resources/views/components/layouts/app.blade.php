    ...
    <header class="bg-white shadow-md">
        <div class="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
            ...
            <nav class="space-x-6 hidden md:flex">
                <a href="" wire:navigate class="text-gray-700 hover:text-blue-600 font-semibold">Home</a>
                <a href="" wire:navigate class="text-gray-700 hover:text-blue-600 font-semibold">Courses</a>
            ...
            <div class="flex items-center space-x-4">
                ...
                @else
                    <a href="}" wire:navigate class="text-blue-600 font-semibold hover:underline">Login</a>
                    <a href="}" wire:navigate class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">Register</a>
                @endif
            </div>
        </div>
    </header>
